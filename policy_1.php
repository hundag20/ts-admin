...
<a class="btn btn-primary" href="edit-policy_1.php?act=add"> <i class="glyphicon glyphicon-plus-sign"></i> Add New
    Policy_1</a>

<h1>Policies for violations punishable by cash</h1>
...
<table id="sorted" class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <td><a href="edit-policy_1.php?act=edit&id=<?php echo $policy_1s['id']?>"><i
                    class="glyphicon glyphicon-edit"></i></a></td>
        <td><a href="save.php?act=delete&id=<?php echo $policy_1s['id']?>&cat=policy_1"
