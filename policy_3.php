...
<a class="btn btn-primary" href="edit-policy_3.php?act=add"> <i class="glyphicon glyphicon-plus-sign"></i> Add New
    Policy_3</a>

<h1>Policies for handling overdue penalty</h1>
...
<table id="sorted" class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <td><a href="edit-policy_3.php?act=edit&id=<?php echo $policy_3s['id']?>"><i
                    class="glyphicon glyphicon-edit"></i></a></td>
        <td><a href="save.php?act=delete&id=<?php echo $policy_3s['id']?>&cat=policy_3"
